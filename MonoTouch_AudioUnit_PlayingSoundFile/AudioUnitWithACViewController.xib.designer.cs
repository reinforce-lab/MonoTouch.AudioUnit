...
namespace Monotouch_AudioUnit_PlayingSoundFile {
	...
	[MonoTouch.Foundation.Register("AudioUnitWithACViewController")]
	public partial class AudioUnitWithACViewController {
		
		private MonoTouch.UIKit.UIView __mt_view;
		
		private MonoTouch.UIKit.UISwitch __mt__loopSwitch;
		...
		[MonoTouch.Foundation.Connect("_loopSwitch")]
		private MonoTouch.UIKit.UISwitch _loopSwitch {
			get {
				this.__mt__loopSwitch = ((MonoTouch.UIKit.UISwitch)(this.GetNativeField("_loopSwitch")));
				return this.__mt__loopSwitch;
			}
			set {
				this.__mt__loopSwitch = value;
				this.SetNativeField("_loopSwitch", value);
			}
		}
